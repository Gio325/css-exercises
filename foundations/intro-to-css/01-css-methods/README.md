...
- Did you properly link the external CSS file in the HTML file? yup
- Does the `div` element have CSS added via the external method? yep
- Does the `p` element have CSS added via the internal method? affermative
- Does the `button` element have CSS added via the inline method? yeah
